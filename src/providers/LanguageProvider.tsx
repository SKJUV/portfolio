...
const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "cert.pageOf": "sur",
    "cert.filter.all": "Toutes",
    "cert.filter.security": "Sécurité",
    "cert.filter.cloud": "Cloud",
    "cert.filter.code": "Code",
    "cert.filter.dev": "Développement",
    "cert.filter.other": "Autres",
    // Contact
  ...
  en: {
    ...
    "cert.pageOf": "of",
    "cert.filter.all": "All",
    "cert.filter.security": "Security",
    "cert.filter.cloud": "Cloud",
    "cert.filter.code": "Code",
    "cert.filter.dev": "Development",
    "cert.filter.other": "Other",
    // Contact
    "contact.title": "Contact",
