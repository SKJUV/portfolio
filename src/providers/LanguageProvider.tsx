...
const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "section.projects.desc": "Des projets concrets avec une approche security-first — uniquement des repos publics.",
    "section.certifications": "Certifications",
    "section.certifications.desc": "Mes certifications et accréditations professionnelles",
    "section.skills": "Compétences",
    "section.skills.desc": "Mon arsenal technique",
  ...
  en: {
    ...
    "section.projects.desc": "Concrete projects with a security-first approach — public repos only.",
    "section.certifications": "Certifications",
    "section.certifications.desc": "My professional certifications and accreditations",
    "section.skills": "Skills",
    "section.skills.desc": "My technical arsenal",
